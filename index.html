...
<script>
  ...
  const URL_APPS_SCRIPT = "https://script.google.com/macros/s/AKfycbxNwwzlLgypLJBzFKMPHNYLcYAXxsloIpoEXQ9ov5TdkdJwjfUEA_awnmUhQbVsV_axGw/exec";
  ...
  async function sincronizarDatosGuardados() {
    ...
    try {
      ...
      if (json && json.exito) {
        ...
        console.error('El servidor respondió con error:', json);
      }
